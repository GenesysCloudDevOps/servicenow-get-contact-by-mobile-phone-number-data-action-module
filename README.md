A Terraform/CX as Code remote module for the following Custom REST API operation: Get Contact by Mobile Phone Number
...
```hcl
module "data_action" {
    source             = "git::https://github.com/GenesysCloudDevOps/custom-rest-get-contact-by-mobile-phone-number-data-action-module.git?ref=v1.0.0"
    action_name        = "Get Contact by Mobile Phone Number"
